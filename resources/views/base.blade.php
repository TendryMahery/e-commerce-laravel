...
<head>
    ...
    <link rel="stylesheet" href="{{asset('tailwind/tailwind.min.css')}}">
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            ...
            <div class="flex items-center md:order-2">
                ...
                @if(Session::has('user'))
                <a href="" class="pr-2 text-green-700">{{Session::get('user')['name']}}</a>
                <a href="/logout" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign up</a>
                @endif
            ...
            <div>
                <form action="/recherche">
                    <input type="text" name="recherche" class="outline-none focus:border-blue-300 text-gray-400 border border-gray-300 p-1 rounded" placeholder="recherche">
                    <button type="submit" class="bg-blue-500 rounded p-1 text-white hover:bg-blue-600">recherche</button>
                </form>
            </div>
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    ...
                    <li>
                        <a href="/list" class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700 text-blue-800">card({{$total}})</a>
                    </li>
                </ul>
            </div>
        </div>
